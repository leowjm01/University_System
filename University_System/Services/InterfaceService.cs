...
namespace University_System.Services
{
    public interface IStudentsService
    {
        ...
        Task<int> Add(Students student);                            // add new student 
    ...
    public interface ITeachersService
    {
        ...
        Task<IEnumerable<Teachers>> GetByName(string name);         // get teachers by student name 
    ...
    public interface IScoreResultsService
    {
